            ...
            <Container maxWidth="3xl">
              <SimpleGrid columns={[1, 2, 2]} textAlign="left" spacing={12} spacingY={24}>
                ...
                <VStack alignItems="start">
                  ...
                  <Box color="gray.500" fontSize="sm">
                    Cusdis is an open-source project. Everyone can sure <strong>we don't track you and your users</strong>. You can also self-host Cusdis easily, to make sure you own your data.
              </Box>
                  <Box pt={2}>
